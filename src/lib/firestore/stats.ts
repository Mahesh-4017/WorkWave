...
import { listJobsByEmployer } from "./jobs";
import { listApplicationsByApplicant, listApplicationsByEmployer } from "./applications";
...
export type DashboardStats =
  | EmployerStats
  | JobseekerStats
  | { role: Exclude<UserRole, "employer" | "jobseeker"> };
